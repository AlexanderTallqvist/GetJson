...
$leaguesStart = "<h3>Leagues</h4><select class='league-dropdown'><option value='leagues'>Choose a league</option>";
$leaguesArray = array();

$teamStart = "<h3>Teams</h4><select class='team-dropdown'><option value='teams'>Choose a team</option>";
$teamArray = array();
